...
const VOICE_COMMANDS = [
  {
    phrase: 'суфлёр стоп',
    desc: 'Пауза. Также: «суфлёр пауза».',
  },
  {
    phrase: 'суфлёр старт',
    desc: 'Продолжить. Можно «суфлёр играй» или «суфлёр слушай».',
  },
  {
    phrase: 'суфлёр сначала',
    desc: 'Перемотать в начало. Также: «суфлёр заново».',
  },
  {
    phrase: 'суфлёр быстрее',
    desc: 'Шаг скорости вверх. Можно «суфлёр скорее».',
  },
  {
    phrase: 'суфлёр медленнее',
    desc: 'Шаг скорости вниз.',
  },
  {
    phrase: 'суфлёр больше',
    desc: 'Крупнее шрифт. Также: «суфлёр крупнее».',
  },
  {
    phrase: 'суфлёр меньше',
    desc: 'Мельче шрифт.',
  },
  {
    phrase: 'суфлёр назад на 10',
    desc: 'Отмотать на N слов. Число можно говорить словом: «пять», «двадцать».',
  },
];
      ...
      <div class="help__content">
        <section class="help__section">
          ...
          <p class="help__section-lead">
            Все команды начинаются со слова <strong>«суфлёр»</strong> — оно работает как пробуждающее слово.
            Текст между ним и командой не считается.
          </p>
