...
const GESTURES = [
  ...
  },
  {
    ...
    desc: 'Шестерёнка — настройки на ходу: шрифт, ширина, линия чтения, зеркало, скорость. Рядом — «из буфера»: заменяет весь текст на скопированный (например, с макбука) и возвращает чтение в начало.',
  },
  {
    iconKey: 'mic',
    title: 'Микрофон в нижней панели',
    desc: 'Включить или выключить голосовое следование. Крестик выхода — слева сверху.',
  },
];
...
const TIPS = [
  ...
  {
    title: 'Настройки — одни на всё',
    desc: 'Шрифт, ширина, положение текста и скорость настраиваются один раз и действуют во всех сценариях. И никуда не денутся после перезапуска.',
  },
];
